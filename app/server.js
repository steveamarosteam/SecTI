...
app.get('/api/obterTextos', async (req, res) => {
  try {
    const usuario = req.session.usuario; // Adicione esta linha para obter o usuário da sessão
...
app.get('/api/obterUltimoTexto', async (req, res) => {
  try {
...
app.get('/api/obterDetalhesPorId/:id', async (req, res) => {
  try {
...
app.get('/api/obterDetalhesSecao/:secao', async (req, res) => {
  try {
...
app.get('/api/obterStatusSecao/:secao', async (req, res) => {
  try {
    const { secao } = req.params;
...
app.post('/api/atualizarStatusSecao', async (req, res) => {
  try {
